			...
			<div className='navbar mb-2 py-6 text-neutral-content max-w-screen-xl mx-auto '>
				...
				<div className='flex-none hidden px-2 mx-2 lg:flex '>
					<div className='flex items-stretch '>
						<a className='btn btn-ghost btn-sm mt-2 mr-2 rounded-btn font-light font-body text-s normal-case hover:bg-transparent'>
							About
						</a>
						<a className='btn btn-ghost btn-sm mt-2 mr-2 rounded-btn font-light font-body text-s normal-case hover:bg-transparent'>
							Services
						</a>
						<a className='btn btn-ghost btn-sm mt-2 mr-2 rounded-btn font-light text-s normal-case hover:bg-transparent'>
							Projects
						</a>
						<a className='btn btn-md rounded-full px-6 border-transparent font-titles text-black text-xs bg-primary-content hover:text-white hover:border-transparent hover:bg-faded-white'>
							Contact
						</a>
					</div>
				</div>
